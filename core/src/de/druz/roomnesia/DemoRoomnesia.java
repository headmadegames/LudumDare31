...
public class DemoRoomnesia extends InputAdapter implements ApplicationListener {
	...
	static final float viewportWidth = 48 * 2;
	static final float viewportHeight = 32 * 2;
	...
	public void create() {
		...
		textureRegion = new TextureRegion(new Texture(Gdx.files.internal("marble.png")));
	...
	public void render() {
		...
		if (showText) {
			...
			font.draw(batch, Integer.toString(Gdx.graphics.getFramesPerSecond()) + "mouse at shadows: " + atShadow
					+ " time used for shadow calculation:" + aika / ++times + "ns", 0, 20);
